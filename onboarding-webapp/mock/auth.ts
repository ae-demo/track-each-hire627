...
// --- The rest is this app's own addition to the standard mock/auth.ts
// surface, mirroring src/auth.ts's Role/getGroups/resolveRole/getRole so
// the module substitution in mock/plugin.ts compiles under --mode mock.
